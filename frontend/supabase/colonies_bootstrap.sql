-- WorldColony — minimal Supabase bootstrap for the current frontend.
-- Use this first if the full schema is awkward to paste into the SQL editor.
